...
class GooglefaSPadminPage extends StatefulWidget {
  // final String userPIN;
  // GooglefaPage({required this.userPIN});

  @override
  State<StatefulWidget> createState() {
    return _GooglefaSPadminPage();
  }
}

class _GooglefaSPadminPage extends State<GooglefaSPadminPage> {
                        ...
                        if (snapshot.exists) {
                          ...
                          if (verify) {
                            ...
                            Navigator.push(context,
                              ...
                              return NavHleperSuperAdminPage();
                            }));
